...
export default function Hero() {
  return (
    <section className="relative min-h-screen grid lg:grid-cols-2 items-center px-4 md:px-16 pt-32 pb-16 overflow-hidden noise">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_70%_50%,rgba(45,204,112,0.15)_0%,transparent_60%)] pointer-events-none" />
      ...
      <div className="relative z-10">
        ...
        <motion.h1
          ...
          className="font-display text-[clamp(3.5rem,8vw,7.5rem)] leading-[0.85] tracking-tight mb-8"
        >
          DON'T JUST <br />
